    ...
    function renderMasterSchedule() {
        ...
        timeSlots.forEach(slot => {
            ...
            weekdays.forEach(day => {
                ...
                html += '<td><div class="day-cell-grid">';
                ...
                if (blocks && Array.isArray(blocks) && blocks.length > 0) {
                    ...
                    blocks.forEach(block => {
                        ...
                        course.groups.forEach(groupName => {
                            ...
                            // 如果只有一個區塊，讓它跨兩欄 (如果是 Grid 佈局)
                            const isSingleBlock = blocks.length === 1 && course.groups.length === 1;
                            const spanClass = isSingleBlock ? 'span-2' : '';

                            html += `
                                <div class="master-group-block ${spanClass}">
                                    <div class="master-group-header">${course.name} <span style="font-size:0.8em">${groupName}</span></div>
            ...
            // Period Column (Now on the Right)
            if (slot.isSpecial) {
                html += `
                    <td class="col-period">
                        <div class="period-cell">
